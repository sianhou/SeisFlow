...
NODES_LIST="node046,node047,node048"  # worker nodes only
...
NPROC_PER_NODE=3
TRAIN_JOB="train4.py --train_data_dir /dreamdata/24yds3d/deeplearning/SeisFlow4/train_dataset64/ --output_dir /dreamdata/24yds3d/deeplearning/SeisFlow4/output_train_dit_size64/ --model_arch dit --log_console --num_workers 4 --pin_memory --batch_size 32"
