...
LOG_DIR="$WORKDIR/logs/recon_pixeldit_seis_dim_nerf_recon_t_i256"
TRAIN_JOB="PixelDiTSeisDimNeRFRecon.py train \
--input_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset256/train/ \
--input_dim_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset256/train_dim/ \
--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/output_recon_pixeldit_seis_dim_nerf_recon_t_i256/ \
--model_arch T \
--batch_size 32 \
--num_epochs 2000 \
