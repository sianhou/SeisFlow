...
TRAIN_JOB="DistSeisDimRecon.py valid \
--ckpt /hwdata/24ydz3d/deeplearning/SeisFlow-main/output_recon_dit_t4_i64/20260801_194940_965771/checkpoint_epoch_00200/ \
--train_data_dim_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_dim/ \
--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_dit_t4_epoch_00200/ \
--model_arch DiT_T_4 \
--input_size 64 \
--batch_size 32 \
