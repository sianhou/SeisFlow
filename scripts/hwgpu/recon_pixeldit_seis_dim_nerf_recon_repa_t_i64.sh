...
LOG_DIR="$WORKDIR/logs/recon_pixeldit_seis_dim_nerf_recon_t_i64"
...
--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/output_recon_pixeldit_seis_dim_nerf_recon_repa_t_i64/ \
--model_arch T \
--batch_size 32 \
--num_epochs 2000 \
