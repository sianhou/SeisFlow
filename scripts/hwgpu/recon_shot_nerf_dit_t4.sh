...
#		--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_recon_shot_nerf_dit_t4_epoch_$j/
	...
	/hwdata/24ydz3d/deeplearning/environments/py313/bin/python3 /hwdata/24ydz3d/deeplearning/SeisFlow-main/diff_shot.py \
		...
		--input2 /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_recon_shot_nerf_dit_t4_epoch_$j/ \
		--output /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/diff_recon_shot_nerf_dit_t4_epoch_$j/
done
