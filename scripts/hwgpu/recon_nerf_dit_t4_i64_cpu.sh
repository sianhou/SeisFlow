...
for ((i = 100; i <=2000; i += 100)); do
	...
	--ckpt /hwdata/24ydz3d/deeplearning/SeisFlow-main/output_recon_nerf_dit_t4_i64/20260801_195609_781426/checkpoint_epoch_$j/ \
	--train_data_dim_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_dim/ \
	--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset64/valid_nerf_dit_t4_epoch__$j/ \
	--model_arch DiT_T_4 \
	--input_size 64 \
	--batch_size 32 \
