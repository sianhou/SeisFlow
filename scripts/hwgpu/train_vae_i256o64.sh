...
LOG_DIR="$WORKDIR/logs/vae_i256o64"
TRAIN_JOB="train_seismic_vae.py \
--train_data_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/shot_dataset256/train/ \
--output_dir /hwdata/24ydz3d/deeplearning/SeisFlow-main/output_vae_i256o64/ \
--input_size 256 \
--latent_size 64 \
--latent_channels 4 \
--batch_size 32 \
