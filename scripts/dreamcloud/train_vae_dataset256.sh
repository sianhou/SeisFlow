...
NPROC_PER_NODE=3
TRAIN_JOB="train_seismic_vae.py --train_data_dir /dreamdata/24yds3d/deeplearning/SeisFlow4/train_dataset256/ --output_dir /dreamdata/24yds3d/deeplearning/SeisFlow4/output_train_vae_dataset256/ --log_console --num_workers 4 --pin_memory --batch_size 32 --num_epochs 500 --autoencoder"
