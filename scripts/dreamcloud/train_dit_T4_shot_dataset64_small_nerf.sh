...
LOG_DIR="$WORKDIR/logs/train_dit_DiT_T_4"
TRAIN_JOB="SeisDimReconNerf.py \
--train_data_dir $WORKDIR/shot_dataset64_small/train/ \
--train_data_dim_dir $WORKDIR/shot_dataset64_small/train_dim \
--output_dir $WORKDIR/output_train_dit_T4_shot_dataset64_small_nerf/ \
--model_arch DiT_T_4 \
--input_size 64 \
--batch_size 8 \
--num_workers 4 \
