...
SEGY="${SEGY:-$PROJ_DIR/shots_001_246_step5_1s_2p5s_4ms.sgy}"
RANDOM_SEGY="${RANDOM_SEGY:-$PROJ_DIR/random_gaussian_50shots.sgy}"
...
for patch_size in 32 64 128; do
    ...
    random_output_dir="$PROJ_DIR/random_shot_dataset${patch_size}_50shots"
