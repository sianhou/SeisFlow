...
class SimpleLogger2Test(unittest.TestCase):
    def test_01_single_process_log_file(self):
        ...
        self.assertIn("[I] cpu_model:", log_text)
        self.assertIn("[I] cpu_logical_threads:", log_text)
        self.assertIn("[I] memory_total_gib:", log_text)
        self.assertIn("[I] disk_total_gib:", log_text)
